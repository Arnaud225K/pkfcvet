...
class SearchTerm(models.Model):
    ...
    ip_address = models.GenericIPAddressField(verbose_name="IP пользователя", null=True, blank=True)
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, editable=False)
...
class SearchChange(models.Model):
    ...
    def __str__(self):
        return f"{self.source} -> {self.result}"
